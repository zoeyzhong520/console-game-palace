<template>
	...
	<view class="recommend-detail-container">
		...
		<view class="recommend-detail-box">
			...
			<view style="padding-top: 30rpx;">
				<u-lazy-load v-for="(item, index) in detailInfo.imageList" :key="index" :image="item" @click="previewImage(index)"></u-lazy-load>
			</view>
		</view>
		...
		<view class="recommend-detail-box" v-if="!cgp_isInReview && detailInfo.resources">
			...
			<view style="padding-top: 30rpx;">
				<u-parse :html="detailInfo.resources" :tag-style="style" :lazy-load="true" :show-with-animation="true" :use-cache="true"></u-parse>
